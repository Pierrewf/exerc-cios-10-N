...
int rankings()
{
	...
	for (i = 0; i < vezesjogadas + 1; i++)
	{
		if (pontosjogador[i] == top1)
		{
			cout << "O jogador top 1 foi o jogador --> " << jogadores[i] << "\n";
		}
	}
	for (i = 0; i < vezesjogadas + 1; i++)
	{
	...
	for (i = 0; i < vezesjogadas + 1; i++)
	{
		...
		{
			cout << "O jogador top 2 foi o jogador --> " << jogadores[i] << "\n";
		}
	}
	for (i = 0; i < vezesjogadas + 1; i++)
	{
	...
	for (i = 0; i < vezesjogadas + 1; i++)
	{
		...
		{
			cout << "O jogador top 3 foi o jogador --> " << jogadores[i] << "\n";
		}
	}
	return 0;
}
